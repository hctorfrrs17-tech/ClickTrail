...
> The video above captures the process of downloading ClickTrail, after doing that process ClickTrail made [THIS TEST GUIDE](assets/clicktrail-github-search-to-zip-validation-guide.pdf).
